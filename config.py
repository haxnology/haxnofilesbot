...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID","958505086"))

#Port
PORT = os.environ.get("PORT", "8081")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://aakasht361:test@cluster0.2tde6va.mongodb.net/?retryWrites=true&w=majority")
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "👋 Hello {first}! Welcome to HaxnoFiles Bot! \n\n🌟Join our main channel @haxnology_official for more! .")
try:
    ADMINS=[]
